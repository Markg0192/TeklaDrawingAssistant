    ...
    public sealed class ControlledEndViewBuilder
    {
            ...
            IList<string> messages)
        {
            ...
            BuildSectionLine(
                ...
                GetPartBox(target, source.View.DisplayCoordinateSystem),
                cut,
                horizontal,
                targetOnLowSide,
                out lineStart,
            ...
            // This is the important simplification: use the source view attributes directly.
            // That preserves the main-view scale, part representation, filters and other
            // drawing settings instead of constructing a half-populated ViewAttributes object.
            ...
            // Diagnostics only. We no longer delete a section because these immediate API
            // queries have proven unreliable directly after CreateSectionView.
            ...
            out Point end)
        {
            if (horizontal)
            {
                ...
                // bottom -> top looks toward +source-X
                // top -> bottom looks toward -source-X
                // Therefore both ends look from outside into the member.
                if (targetOnLowSide)
                {
                    start = bottom;
                    end = top;
            ...
            // right -> left looks toward +source-Y
        ...
        private static void RemoveExistingSectionMark(DrawingView source, string markName)
        {
            if (source == null)
                return;
